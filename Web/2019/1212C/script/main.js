...
$(function () {
 ...
 $("#PageIndex").css("background-image","url(/Content/2019/1212C/images/index-top.png?v="  + Math.floor(Math.random() * 1000)  + "), url(/Content/2019/1212C/images/bg.jpg)")
$(".bg-middle").css("background-image","url(/Content/2019/1212C/images/index-middle.png?v="  + Math.floor(Math.random() * 1000)  + ")")
$(".alert .rule-img").css("background-image", "url(/Content/2019/1212C/images/rule.png?v="  + Math.floor(Math.random() * 1000)  + ")");

$("#PageIndex .btns-index-flex").css("background-image", "url(/Content/2019/1212C/images/index-bottom.png?v="  + Math.floor(Math.random() * 1000)  + ")");
var Scroll1;
    ...
    function handleComplete() {
      ...
      getUserInfo();  $('#btnRank').on('click', alertRankShow);
...
//$("#PageIndex").css("background-image", "url(/Content/2019/1212C/images/index-top.png), url(/Content/2019/1212C/images/bg.jpg)");
                    ...
                    SHARE.shareOption({
                        ...
                        pic: "http://weixin.seemoread.com/Content/2019/1212C/share.jpg?v=11",
                        title: "圣诞人气王 欢乐开宝箱",
                        desc: "iPad Air、MacBook Pro、HUWEI P30 Pro等惊喜豪礼等你来拿~",
                        success: function () { }
                    });
